...
class Director:
  ...
  Attributes:
    _keyboard_service (KeyboardService): getting directional input
    _video_service (VideoService): providing video output
  """
  def __init__(self, keyboard_service, video_service):
    """Construct a new Director using the specified keyboard and video services
    Args:
  ...
  def _get_inputs(self, cast):
    """Get directional inut from the keyboard and applies it to the robot
    Args:
      cast (Cast): Cast of actors
    """
  ...
  def _do_updates(self, cast):
    """Updates the robot's position, resolves any collisions with artifacts,
    remove artifacts that fall off the screen and spawns new artifacts from the top of the screen
    Args:
      cast (Cast): Cast of actors
    """
    ...
    if self._frames % 4 == 0:
      ...
      #if a gem is moving out of bonds, mark it for removal
      for gem in gems:
